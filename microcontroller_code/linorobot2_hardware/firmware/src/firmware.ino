...
Motor motor1_controller(PWM_FREQUENCY, PWM_BITS, MOTOR1_INV, MOTOR1_PWM, LEFT_DIRECTION, MOTOR1_IN_A, MOTOR1_IN_B);
Motor motor2_controller(PWM_FREQUENCY, PWM_BITS, MOTOR2_INV, MOTOR2_PWM, RIGHT_DIRECTION, MOTOR2_IN_A, MOTOR2_IN_B);
Motor motor3_controller(PWM_FREQUENCY, PWM_BITS, MOTOR3_INV, MOTOR3_PWM, LEFT_DIRECTION, MOTOR3_IN_A, MOTOR3_IN_B);
Motor motor4_controller(PWM_FREQUENCY, PWM_BITS, MOTOR4_INV, MOTOR4_PWM, RIGHT_DIRECTION, MOTOR4_IN_A, MOTOR4_IN_B);
Motor motor5_controller(PWM_FREQUENCY, PWM_BITS, MOTOR5_INV, MOTOR5_PWM, LEFT_DIRECTION, MOTOR5_IN_A, MOTOR5_IN_B);
Motor motor6_controller(PWM_FREQUENCY, PWM_BITS, MOTOR6_INV, MOTOR6_PWM, RIGHT_DIRECTION, MOTOR6_IN_A, MOTOR6_IN_B);
