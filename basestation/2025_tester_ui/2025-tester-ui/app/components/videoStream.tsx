// Video stream component for displaying the live video feed, but I still have NO idea how to get this to work - JC
...
const StartStream = ({send_json,message}:{send_json: (msg: RTCSessionDescription | RTCIceCandidate | RTCSessionDescriptionInit) => void,message?:any}) => {
  ...
  return (
    <div className='col-span-3 row-span-2 bg-gray-900 rounded-lg p-4'>
      <div className="flex flex-row justify-between items-center mb-4 pb-4 border-b border-gray-700">
        <h3 className="text-white font-semibold">Streams</h3>
        <div className="flex items-center space-x-2">
          <select 
            defaultValue='both' 
            onChange={(e) => setSelectedVideo(e.target.value)}
            className="px-3 py-2 rounded bg-gray-800 text-white text-sm border border-gray-600"
          >
          ...
          <button 
            ...
            className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700 text-sm font-medium"
          >
